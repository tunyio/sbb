...
import { defineCrudAbilityForUsersListRolePivot } from './define-user-ability';
...
export const crudAuthOptionsForUsersListRolePivot: AuthOptions = {
...
function getChecksInsideCaslResponsibility(args: ProceedCrudAuth): void {
  const userAbility = defineCrudAbilityForUsersListRolePivot(args);
