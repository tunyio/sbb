...
import { defineCrudAbilityForUsersList } from './define-user-ability';
...
export const crudAuthOptionsForUsersList: AuthOptions = {
...
function getChecksInsideCaslResponsibility(args: ProceedCrudAuth): void {
  const userAbility = defineCrudAbilityForUsersList(args);
