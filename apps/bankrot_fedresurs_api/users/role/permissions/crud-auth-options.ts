...
import { defineCrudAbilityForUsersRole } from './define-user-ability';
...
export const crudAuthOptionsForUsersRole: AuthOptions = {
...
function getChecksInsideCaslResponsibility(args: ProceedCrudAuth): void {
  const userAbility = defineCrudAbilityForUsersRole(args);
