...
import { defineCrudAbilityForUsersContacts } from './define-user-ability';
...
export const crudAuthOptionsForUsersContacts: AuthOptions = {
...
function getChecksInsideCaslResponsibility(args: ProceedCrudAuth): void {
  const userAbility = defineCrudAbilityForUsersContacts(args);
