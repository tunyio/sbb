...
import { defineCrudAbilityForAuctionsList } from './define-user-ability';
...
export const crudAuthOptionsForAuctionsList: AuthOptions = {
...
function getChecksInsideCaslResponsibility(args: ProceedCrudAuth): void {
  const userAbility = defineCrudAbilityForAuctionsList(args);
