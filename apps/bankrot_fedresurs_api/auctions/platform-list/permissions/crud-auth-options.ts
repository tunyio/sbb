...
import { defineCrudAbilityForAuctionsPlatformList } from './define-user-ability';
...
export const crudAuthOptionsForAuctionsPlatformList: AuthOptions = {
...
function getChecksInsideCaslResponsibility(args: ProceedCrudAuth): void {
  const userAbility = defineCrudAbilityForAuctionsPlatformList(args);
