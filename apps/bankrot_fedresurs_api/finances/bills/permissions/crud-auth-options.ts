...
import { defineCrudAbilityForFinancesBills } from './define-user-ability';
...
export const crudAuthOptionsForFinancesBills: AuthOptions = {
...
function getChecksInsideCaslResponsibility(args: ProceedCrudAuth): void {
  const userAbility = defineCrudAbilityForFinancesBills(args);
