...
import { defineCrudAbilityForFinancesActions } from './define-user-ability';
...
export const crudAuthOptionsForFinancesActions: AuthOptions = {
...
function getChecksInsideCaslResponsibility(args: ProceedCrudAuth): void {
  const userAbility = defineCrudAbilityForFinancesActions(args);
