...
import { defineCrudAbilityForDeptorsLegalList } from './define-user-ability';
...
export const crudAuthOptionsForDeptorsLegalList: AuthOptions = {
...
function getChecksInsideCaslResponsibility(args: ProceedCrudAuth): void {
  const userAbility = defineCrudAbilityForDeptorsLegalList(args);
