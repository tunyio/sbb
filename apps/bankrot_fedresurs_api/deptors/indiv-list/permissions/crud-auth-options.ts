...
import { defineCrudAbilityForDeptorsIndivList } from './define-user-ability';
...
export const crudAuthOptionsForDeptorsIndivList: AuthOptions = {
...
function getChecksInsideCaslResponsibility(args: ProceedCrudAuth): void {
  const userAbility = defineCrudAbilityForDeptorsIndivList(args);
