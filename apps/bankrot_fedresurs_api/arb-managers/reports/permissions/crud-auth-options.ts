...
import { defineCrudAbilityForArbManagersReports } from './define-user-ability';
...
export const crudAuthOptionsForArbManagersReports: AuthOptions = {
...
function getChecksInsideCaslResponsibility(args: ProceedCrudAuth): void {
  const userAbility = defineCrudAbilityForArbManagersReports(args);
