...
import { defineCrudAbilityForArbManagersList } from './define-user-ability';
...
export const crudAuthOptionsForArbManagersList: AuthOptions = {
...
function getChecksInsideCaslResponsibility(args: ProceedCrudAuth): void {
  const userAbility = defineCrudAbilityForArbManagersList(args);
