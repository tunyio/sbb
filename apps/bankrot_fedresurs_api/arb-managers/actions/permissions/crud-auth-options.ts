...
import { defineCrudAbilityForArbManagersActions } from './define-user-ability';
...
export const crudAuthOptionsForArbManagersActions: AuthOptions = {
...
function getChecksInsideCaslResponsibility(args: ProceedCrudAuth): void {
  const userAbility = defineCrudAbilityForArbManagersActions(args);
