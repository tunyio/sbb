...
import { defineCrudAbilityForMessagesList } from './define-user-ability';
...
export const crudAuthOptionsForMessagesList: AuthOptions = {
...
function getChecksInsideCaslResponsibility(args: ProceedCrudAuth): void {
  const userAbility = defineCrudAbilityForMessagesList(args);
