...
import { defineCrudAbilityForMessagesPublisherList } from './define-user-ability';
...
export const crudAuthOptionsForMessagesPublisherList: AuthOptions = {
...
function getChecksInsideCaslResponsibility(args: ProceedCrudAuth): void {
  const userAbility = defineCrudAbilityForMessagesPublisherList(args);
