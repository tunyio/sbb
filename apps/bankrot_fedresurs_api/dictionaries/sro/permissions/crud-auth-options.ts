...
import { defineCrudAbilityForDictSro } from './define-user-ability';
...
export const crudAuthOptionsForDictSro: AuthOptions = {
...
function getChecksInsideCaslResponsibility(args: ProceedCrudAuth): void {
  const userAbility = defineCrudAbilityForDictSro(args);
