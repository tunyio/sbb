...
import { defineCrudAbilityForDictAuctPlatforms } from './define-user-ability';
...
export const crudAuthOptionsForDictAuctPlatforms: AuthOptions = {
...
function getChecksInsideCaslResponsibility(args: ProceedCrudAuth): void {
  const userAbility = defineCrudAbilityForDictAuctPlatforms(args);
