...
import { defineCrudAbilityForDictRegion } from './define-user-ability';
...
export const crudAuthOptionsForDictRegion: AuthOptions = {
...
function getChecksInsideCaslResponsibility(args: ProceedCrudAuth): void {
  const userAbility = defineCrudAbilityForDictRegion(args);
