...
import { defineCrudAbilityForDictAuctPlatformsSro } from './define-user-ability';
...
export const crudAuthOptionsForDictAuctPlatformsSro: AuthOptions = {
...
function getChecksInsideCaslResponsibility(args: ProceedCrudAuth): void {
  const userAbility = defineCrudAbilityForDictAuctPlatformsSro(args);
