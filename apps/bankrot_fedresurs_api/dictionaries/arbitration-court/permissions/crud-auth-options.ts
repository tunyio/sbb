...
import { defineCrudAbilityForDictArbitrationCourt } from './define-user-ability';
...
export const crudAuthOptionsForDictArbitrationCourt: AuthOptions = {
...
function getChecksInsideCaslResponsibility(args: ProceedCrudAuth): void {
  const userAbility = defineCrudAbilityForDictArbitrationCourt(args);
