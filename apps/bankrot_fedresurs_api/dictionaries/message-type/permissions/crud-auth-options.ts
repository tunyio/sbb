...
import { defineCrudAbilityForDictMessageType } from './define-user-ability';
...
export const crudAuthOptionsForDictMessageType: AuthOptions = {
...
function getChecksInsideCaslResponsibility(args: ProceedCrudAuth): void {
  const userAbility = defineCrudAbilityForDictMessageType(args);
