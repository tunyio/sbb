...
import { defineCrudAbilityForAuctionOrgsLegalList } from './define-user-ability';
...
export const crudAuthOptionsForAuctionOrgsLegalList: AuthOptions = {
...
function getChecksInsideCaslResponsibility(args: ProceedCrudAuth): void {
  const userAbility = defineCrudAbilityForAuctionOrgsLegalList(args);
