...
import { defineCrudAbilityForAuctionOrgsIndivList } from './define-user-ability';
...
export const crudAuthOptionsForAuctionOrgsIndivList: AuthOptions = {
...
function getChecksInsideCaslResponsibility(args: ProceedCrudAuth): void {
  const userAbility = defineCrudAbilityForAuctionOrgsIndivList(args);
